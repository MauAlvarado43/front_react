...
const ProjectDetails = ({ project, onClickDelete }) =>
  <div class="card">
    ...
    <div class="card-footer">
      <div class="d-flex justify-content-end">
        <Link to={`/${project.id}/edit`} class="btn btn-secondary mr-2">Edit project</Link>
        <button class="btn btn-danger" onClick={onClickDelete}>Delete project</button>
      </div>
    </div>
  </div>;
